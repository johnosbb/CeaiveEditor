...
class WordForColorDescriptorsSelectorDialog(QDialog):
    def __init__(self,  title, classifications, parent=None,):
        ...
        self.lastStart = 0
        self.title = title
        self.proxyModel = SortWordsForColorDescriptorFilterProxyModel(self)
    ...
    def resetFilterEnables(self):
        self.colourDescriptorFilterEnabled = False
    ...
    def createHeader(self):
        ...
        self.headerSpacerWidget.setObjectName("headerSpacerWidget")
        self.colourDescriptorFilter = QLineEdit(self.headerFrame)
        ...
        self.colourDescriptorFilter.setToolTip(
    ...
    def setWordFilter(self):
        text = self.colourDescriptorFilter.text()
        if((text is not None) and (not text.isspace()) and (text != "")):
            self.filterString = "" + text
            self.colourDescriptorFilterPattern = repr(
                self.filterString)[1:-1]
            self.filterColumn = 0
            self.colourDescriptorFilterEnabled = True
